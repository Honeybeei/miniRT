...
/*   Updated: 2023/02/03 21:37:03 by seoyoo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_light_cntl_mode_ui(t_ptrs *ptrs)
{
	...
	info_arr[1] = join_str_and_vector("Light point : ", \
	ptrs->objs_.lights_[i].light_point_, VECTOR_PRECISION_);
	info_arr[2] = join_str_and_double("Brightness  : ", \
	ptrs->objs_.lights_[i].ratio_, DOUBLE_PRECISION_);
	i = 0;
